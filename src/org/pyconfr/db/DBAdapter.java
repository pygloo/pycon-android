...
public class DBAdapter extends ContentProvider {
	...
	// Provider related
	public static final String PROVIDER_NAME = "org.pyconfr.pojo.Event";
	...
	public String getType(Uri uri) {
		switch (uriMatcher.match(uri)) {
		case EVENTS:
			return "vnd.org.pyconfr.events/vnd.fosdem.org";
		case EVENT_ID:
			return "vnd.org.pyconfr.event/vnd.fosdem.org";
		default:
