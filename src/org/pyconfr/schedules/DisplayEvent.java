...
import org.pyconfr.views.FavoriteButton;
...
public class DisplayEvent extends Activity {
	...
	public final static String ACTION_DISPLAY_EVENT = "org.pyconfr.schedules.DISPLAY_EVENT";

	/** Id extras parameter name */
	public final static String ID = "org.pyconfr.Id";
	...
	private void showEvent(Event event) {
		...
		if (eventDescription.length() == 0)
			eventDescription = "No lecture description available.";
	...
	public void share() {
		...
		String extra = "J'assisterais à '" + event.getTitle() + "' (Jour "
				+ (event.getDayindex()) + " à "
		...
		if (currentTime >= event.getStart().getTime()
			...
			extra = "J'assiste à '" + event.getTitle() + "' ("
					+ event.getRoom() + ") #pyconfr"; //#fosdem
